export const LIVE_EMPLOYEES = [
  {
    ...
    "workLogFeedback": [
      {
        "date": "12-Oct",
        "comment": "Shipped quantum UI component ahead of schedule.",
        "sentiment": "positive"
      },
      {
        "date": "15-Oct",
        "comment": "Pair programming session was highly effective.",
        "sentiment": "positive"
      },
      {
        "date": "18-Oct",
        "comment": "Minor regression in build step, quickly resolved.",
        "sentiment": "neutral"
      }
    ],
    "projectedPromotions": [
    ...
    "lmsModules": [
      ...
      {
        "id": "l3",
        "title": "Leadership Communication II",
        "status": "enrolled",
        "progress": 0,
        "score": null,
        "date": "Upcoming"
    ...
    "okrs": [
      {
        "objective": "Migrate entire UI to React 19",
        "progress": 85,
        "status": "on_track",
        "weight": "High"
      },
      {
        "objective": "Reduce bundle size by 40%",
        "progress": 100,
        "status": "completed",
        "weight": "Critical"
      },
      {
        "objective": "Mentor 3 junior developers",
        "progress": 50,
        "status": "at_risk",
        "weight": "Medium"
      }
    ...
    "compensation": {
      ...
      "bonus": 30000,
      "equityVested": 120000,
      "equityUnvested": 240000,
      "nextVestDate": "15-Nov-2026",
      "wellnessStipend": 1500,
      "utilizedStipend": 800
    },
    "leaveBalance": {
      "ptoTotal": 25,
      ...
      "sickTotal": 10,
      "sickUsed": 2,
      "sabbaticalEligible": false
    },
    "bioRhythm": {
      "stressIndex": 28,
      "cognitiveLoad": 65,
      "burnoutProbability": 14,
      "sleepQuality": 88,
      "focusBlocksAvg": 4.2
    },
    "peerReviews": [
  ...
  },
  {
    ...
    "workLogFeedback": [
      {
        "date": "01-Nov",
        "comment": "Great wireframes for new onboarding flow.",
        "sentiment": "positive"
      },
      {
        "date": "05-Nov",
        "comment": "Needs more context on edge cases in UI.",
        "sentiment": "neutral"
      }
    ],
    "projectedPromotions": [
    ...
    "okrs": [
      {
        "objective": "Establish Design Token sync pipeline",
        "progress": 60,
        "status": "on_track",
        "weight": "High"
      },
      {
        "objective": "Conduct 15 user interviews for Q4",
        "progress": 80,
        "status": "on_track",
        "weight": "Medium"
      }
    ...
    "compensation": {
      ...
      "bonus": 10000,
      "equityVested": 0,
      "equityUnvested": 80000,
      "nextVestDate": "10-Oct-2027",
      "wellnessStipend": 1500,
      "utilizedStipend": 1500
    },
    "leaveBalance": {
      "ptoTotal": 25,
      "ptoUsed": 5,
  ...
  },
  {
    ...
    "workLogFeedback": [
      {
        "date": "10-Oct",
        "comment": "Microservice API documentation incomplete.",
        "sentiment": "negative"
      },
      {
        "date": "14-Oct",
        "comment": "Fixed critical database deadlocks.",
        "sentiment": "positive"
      },
      {
        "date": "20-Oct",
        "comment": "Absent for sprint planning.",
        "sentiment": "negative"
      }
    ],
    "projectedPromotions": [
    ...
    "okrs": [
      {
        "objective": "Migrate auth service to zero-trust architecture",
        "progress": 30,
        "status": "off_track",
        "weight": "Critical"
      },
      {
        "objective": "Reduce API latency by 200ms",
        "progress": 75,
        "status": "on_track",
        "weight": "High"
      }
    ...
    "compensation": {
      ...
      "bonus": 5000,
      "equityVested": 60000,
      "equityUnvested": 20000,
      "nextVestDate": "01-Jan-2027",
      "wellnessStipend": 1500,
      "utilizedStipend": 0
    },
    "leaveBalance": {
  ...
  },
  {
    ...
    "workLogFeedback": [
      {
        "date": "02-Nov",
        "comment": "Q4 SEO Campaign yielding excellent organic traffic.",
        "sentiment": "positive"
      },
      {
        "date": "08-Nov",
        "comment": "Siloed communication with sales team noted.",
        "sentiment": "negative"
      }
    ],
    "projectedPromotions": [
    ...
    "okrs": [
      {
        "objective": "Increase Organic Traffic by 35%",
        "progress": 95,
        "status": "on_track",
        "weight": "Critical"
      },
      {
        "objective": "Launch 3 joint campaigns with Sales",
        "progress": 20,
        "status": "at_risk",
        "weight": "High"
      }
    ...
    "compensation": {
      ...
      "bonus": 25000,
      "equityVested": 30000,
      "equityUnvested": 40000,
      "nextVestDate": "15-May-2026",
      "wellnessStipend": 1500,
      "utilizedStipend": 500
    },
    "leaveBalance": {
  ...
  },
  {
    ...
    "workLogFeedback": [
      {
        "date": "03-Nov",
        "comment": "Stakeholder alignment session resulted in 3 new feature approvals.",
        "sentiment": "positive"
      },
      {
        "date": "10-Nov",
        "comment": "Discovery sprint yielded actionable user insights.",
        "sentiment": "positive"
      }
    ],
    "projectedPromotions": [
    ...
    "okrs": [
      {
        "objective": "Launch v2 onboarding flow",
        "progress": 90,
        "status": "on_track",
        "weight": "High"
      },
      ...
      {
        "objective": "Define 2026 product roadmap",
        "progress": 100,
        "status": "completed",
        "weight": "High"
      }
    ...
    "compensation": {
      ...
      "bonus": 20000,
      "equityVested": 15000,
      "equityUnvested": 30000,
      "nextVestDate": "01-Mar-2026",
      "wellnessStipend": 1200,
      "utilizedStipend": 900
    },
    "leaveBalance": {
      "ptoTotal": 20,
  ...
  },
  {
    ...
    "workLogFeedback": [
      {
        "date": "05-Nov",
        "comment": "Refactored ingestion layer — 30% latency reduction.",
        "sentiment": "positive"
      },
      {
        "date": "12-Nov",
        "comment": "Documentation backlog still unresolved from last sprint.",
        "sentiment": "neutral"
      }
    ],
    "projectedPromotions": [
    ...
    "okrs": [
      {
        "objective": "Achieve 99.9% pipeline uptime",
        "progress": 96,
        "status": "on_track",
        "weight": "Critical"
      },
      {
        "objective": "Migrate legacy ETL to dbt",
        "progress": 45,
        "status": "at_risk",
        "weight": "High"
      },
      {
        "objective": "Document all data contracts",
        "progress": 20,
        "status": "off_track",
        "weight": "Medium"
      }
    ...
    "compensation": {
      ...
      "bonus": 10000,
      "equityVested": 8000,
      "equityUnvested": 22000,
      "nextVestDate": "01-Aug-2026",
      "wellnessStipend": 1200,
      "utilizedStipend": 200
    },
    "leaveBalance": {
  ...
  },
  {
    ...
    "workLogFeedback": [
      {
        "date": "07-Nov",
        "comment": "Delivered research synthesis deck — 12 actionable insights adopted by product.",
        "sentiment": "positive"
      },
      {
        "date": "14-Nov",
        "comment": "Moderated 8 usability sessions this week, above target.",
        "sentiment": "positive"
      }
    ],
    "projectedPromotions": [
    ...
    "lmsModules": [
      ...
      {
        "id": "l2",
        "title": "Quantitative UX Analysis",
        "status": "in_progress",
        "progress": 70,
        "score": null,
        "date": "Ongoing"
    ...
    "okrs": [
      {
        "objective": "Conduct 40 user interviews this quarter",
        "progress": 80,
        "status": "on_track",
        "weight": "High"
      },
      {
        "objective": "Build shared research repository",
        "progress": 55,
        "status": "on_track",
        "weight": "Medium"
      },
      {
        "objective": "Define UX metrics framework",
        "progress": 100,
        "status": "completed",
        "weight": "High"
      }
    ...
    "compensation": {
      ...
      "bonus": 12000,
      "equityVested": 6000,
      "equityUnvested": 18000,
      "nextVestDate": "01-Jun-2026",
      "wellnessStipend": 1200,
      "utilizedStipend": 1100
    },
    "leaveBalance": {
      "ptoTotal": 20,
      "ptoUsed": 7,
  ...
  },
  {
    ...
    "workLogFeedback": [
      {
        "date": "06-Nov",
        "comment": "Deployment pipeline now averages 4.2 min — 40% faster than last quarter.",
        "sentiment": "positive"
      },
      {
        "date": "13-Nov",
        "comment": "Missed sprint planning. On-call rotation may be causing burnout.",
        "sentiment": "neutral"
      }
    ],
    "projectedPromotions": [
    ...
    "okrs": [
      ...
      {
        "objective": "Reduce infra costs by 20%",
        "progress": 30,
        "status": "at_risk",
        "weight": "High"
      },
      {
        "objective": "Complete Kubernetes certification",
        "progress": 10,
        "status": "off_track",
        "weight": "Medium"
      }
